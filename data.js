const ARCHIVE = [
  ...
  },
  {
    ...
    description: "성모 마리아가 서기 42년 로마 점령하의 유대에서 보냈다고 전해지는 편지의 채색 필사본으로, 17세기 말에 제작된 사본이다. 이 편지는 사도 바울과 메시나의 명사 네 명으로 구성된 사절단이 성지로 파견된 후, 시칠리아 항구 도시 메시나 시민들에게 축복의 메시지로 보낸 것이다. 성모 마리아 숭배가 확고히 자리 잡기 시작한 지 거의 반세기 후에 제작된 이 필사본은 서기관이 가끔씩 만들어 순례자들과 신도들에게 판매했던 기념품일 가능성이 높다.",
    year: "1674-1678",
    realityMode: "spent_fake",
    presentStatus: "discarded_fake",
    valueType: "historical_value",
